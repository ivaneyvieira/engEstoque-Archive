...
abstract class CrudLayoutView<C: EntityVo<*>, V: CrudViewModel<*, *, C>>: LayoutView<V>() {
  var gridCrud: GridCrudFlex<C>? = null
...
open class GridCrudFlex<T: EntityVo<*>>(domainType: Class<T>,
  ...
  private val dataProvider = DataProvider.fromFilteringCallbacks(find, count).withConfigurableFilter()
  ...
  override fun showForm(operation: CrudOperation,
    ...
    val form = crudFormFactory.buildNewForm(operation, domainObject, readOnly, {_ ->
