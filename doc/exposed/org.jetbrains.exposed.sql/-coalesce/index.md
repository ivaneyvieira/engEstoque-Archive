[org.jetbrains.exposed.sql](../index.md) / [Coalesce](.)

# Coalesce

`class Coalesce<out T, S : T?, R : T> : `[`Function`](../-function/index.md)`<R>`

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `Coalesce(expr: `[`ExpressionWithColumnType`](../-expression-with-column-type/index.md)`<S>, alternate: `[`ExpressionWithColumnType`](../-expression-with-column-type/index.md)`<out T>)` |
