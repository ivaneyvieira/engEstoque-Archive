[org.jetbrains.exposed.sql](../index.md) / [AndOp](.)

# AndOp

`class AndOp : `[`Op`](../-op/index.md)`<Boolean>`

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `AndOp(expr1: `[`Expression`](../-expression/index.md)`<Boolean>, expr2: `[`Expression`](../-expression/index.md)`<Boolean>)` |

### Properties

| Name | Summary |
|---|---|
| [expr1](expr1.md) | `val expr1: `[`Expression`](../-expression/index.md)`<Boolean>` |
| [expr2](expr2.md) | `val expr2: `[`Expression`](../-expression/index.md)`<Boolean>` |
