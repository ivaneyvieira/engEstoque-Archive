[org.jetbrains.exposed.sql](../index.md) / [InListOrNotInListOp](.)

# InListOrNotInListOp

`class InListOrNotInListOp<T> : `[`Op`](../-op/index.md)`<Boolean>`

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `InListOrNotInListOp(expr: `[`ExpressionWithColumnType`](../-expression-with-column-type/index.md)`<T>, list: Iterable<T>, isInList: Boolean = true)` |

### Properties

| Name | Summary |
|---|---|
| [expr](expr.md) | `val expr: `[`ExpressionWithColumnType`](../-expression-with-column-type/index.md)`<T>` |
| [isInList](is-in-list.md) | `val isInList: Boolean` |
| [list](list.md) | `val list: Iterable<T>` |
