[org.jetbrains.exposed.sql](../index.md) / [GroupConcat](.)

# GroupConcat

`class GroupConcat : `[`Function`](../-function/index.md)`<String?>`

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `GroupConcat(expr: `[`Column`](../-column/index.md)`<*>, separator: String?, distinct: Boolean, vararg orderBy: <ERROR CLASS><`[`Expression`](../-expression/index.md)`<*>, Boolean>)` |

### Properties

| Name | Summary |
|---|---|
| [distinct](distinct.md) | `val distinct: Boolean` |
| [expr](expr.md) | `val expr: `[`Column`](../-column/index.md)`<*>` |
| [orderBy](order-by.md) | `vararg val orderBy: Array<out <ERROR CLASS><`[`Expression`](../-expression/index.md)`<*>, Boolean>>` |
| [separator](separator.md) | `val separator: String?` |
