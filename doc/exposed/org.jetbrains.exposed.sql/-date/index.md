[org.jetbrains.exposed.sql](../index.md) / [Date](.)

# Date

`class Date<T> : `[`Function`](../-function/index.md)`<<ERROR CLASS>>`

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `Date(expr: `[`Expression`](../-expression/index.md)`<T>)` |
...
| [date](../date.md) | `fun <T> `[`Expression`](../-expression/index.md)`<T>.date(): Date<T>` |
