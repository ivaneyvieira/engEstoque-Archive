[org.jetbrains.exposed.sql](../index.md) / [DivideOp](.)

# DivideOp

`class DivideOp<T, S : T> : `[`ExpressionWithColumnType`](../-expression-with-column-type/index.md)`<T>`

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `DivideOp(expr1: `[`Expression`](../-expression/index.md)`<T>, expr2: `[`Expression`](../-expression/index.md)`<S>, columnType: `[`IColumnType`](../-i-column-type/index.md)`)` |
