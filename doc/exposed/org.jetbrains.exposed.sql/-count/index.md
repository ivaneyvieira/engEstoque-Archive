[org.jetbrains.exposed.sql](../index.md) / [Count](.)

# Count

`class Count : `[`Function`](../-function/index.md)`<Int>`

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `Count(expr: `[`Expression`](../-expression/index.md)`<*>, distinct: Boolean = false)` |
