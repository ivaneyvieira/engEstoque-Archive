[org.jetbrains.exposed.sql](../index.md) / [NoOpConversion](.)

# NoOpConversion

`class NoOpConversion<T, S> : `[`ExpressionWithColumnType`](../-expression-with-column-type/index.md)`<S>`

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `NoOpConversion(expr: `[`Expression`](../-expression/index.md)`<T>, columnType: `[`IColumnType`](../-i-column-type/index.md)`)` |
