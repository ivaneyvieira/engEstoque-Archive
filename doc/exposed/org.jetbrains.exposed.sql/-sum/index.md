[org.jetbrains.exposed.sql](../index.md) / [Sum](.)

# Sum

`class Sum<T> : `[`Function`](../-function/index.md)`<T?>`

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `Sum(expr: `[`Expression`](../-expression/index.md)`<T>, _columnType: `[`IColumnType`](../-i-column-type/index.md)`)` |
...
| [sum](../sum.md) | `fun <T> `[`ExpressionWithColumnType`](../-expression-with-column-type/index.md)`<T>.sum(): Sum<T>` |
