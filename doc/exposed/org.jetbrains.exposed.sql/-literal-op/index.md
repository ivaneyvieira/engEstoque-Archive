[org.jetbrains.exposed.sql](../index.md) / [LiteralOp](.)

# LiteralOp

`class LiteralOp<T> : `[`ExpressionWithColumnType`](../-expression-with-column-type/index.md)`<T>`

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `LiteralOp(columnType: `[`IColumnType`](../-i-column-type/index.md)`, value: T)` |
