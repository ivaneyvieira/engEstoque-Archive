[org.jetbrains.exposed.sql](../index.md) / [VarSamp](.)

# VarSamp

`class VarSamp<T> : `[`Function`](../-function/index.md)`<`[`BigDecimal`](http://docs.oracle.com/javase/6/docs/api/java/math/BigDecimal.html)`?>`

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `VarSamp(expr: `[`Expression`](../-expression/index.md)`<T>, scale: Int)` |
...
| [varSamp](../var-samp.md) | `fun <T> `[`ExpressionWithColumnType`](../-expression-with-column-type/index.md)`<T>.varSamp(scale: Int = 2): VarSamp<T>` |
