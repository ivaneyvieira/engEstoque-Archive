[org.jetbrains.exposed.sql](../index.md) / [VarPop](.)

# VarPop

`class VarPop<T> : `[`Function`](../-function/index.md)`<`[`BigDecimal`](http://docs.oracle.com/javase/6/docs/api/java/math/BigDecimal.html)`?>`

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `VarPop(expr: `[`Expression`](../-expression/index.md)`<T>, scale: Int)` |
...
| [varPop](../var-pop.md) | `fun <T> `[`ExpressionWithColumnType`](../-expression-with-column-type/index.md)`<T>.varPop(scale: Int = 2): VarPop<T>` |
