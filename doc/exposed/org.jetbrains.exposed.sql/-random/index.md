[org.jetbrains.exposed.sql](../index.md) / [Random](.)

# Random

`class Random : `[`Function`](../-function/index.md)`<`[`BigDecimal`](http://docs.oracle.com/javase/6/docs/api/java/math/BigDecimal.html)`>`

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `Random(seed: Int? = null)` |

### Properties

| Name | Summary |
|---|---|
| [seed](seed.md) | `val seed: Int?` |
