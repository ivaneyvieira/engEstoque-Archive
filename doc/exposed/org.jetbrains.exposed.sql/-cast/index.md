[org.jetbrains.exposed.sql](../index.md) / [Cast](.)

# Cast

`class Cast<T> : `[`Function`](../-function/index.md)`<T?>`

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `Cast(expr: `[`Expression`](../-expression/index.md)`<*>, columnType: `[`IColumnType`](../-i-column-type/index.md)`)` |
...
| [castTo](../cast-to.md) | `fun <R : Any> `[`Expression`](../-expression/index.md)`<*>.castTo(columnType: `[`IColumnType`](../-i-column-type/index.md)`): Cast<R>` |
