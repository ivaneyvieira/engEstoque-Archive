[org.jetbrains.exposed.sql](../index.md) / [Min](.)

# Min

`class Min<T : Comparable<T>, in S : T?> : `[`Function`](../-function/index.md)`<T?>`

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `Min(expr: `[`Expression`](../-expression/index.md)`<in S>, _columnType: `[`IColumnType`](../-i-column-type/index.md)`)` |
