[org.jetbrains.exposed.sql](../index.md) / [LowerCase](.)

# LowerCase

`class LowerCase<T : String?> : `[`Function`](../-function/index.md)`<T>`

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `LowerCase(expr: `[`Expression`](../-expression/index.md)`<T>)` |
