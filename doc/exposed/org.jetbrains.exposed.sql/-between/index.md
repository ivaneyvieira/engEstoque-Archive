[org.jetbrains.exposed.sql](../index.md) / [Between](.)

# Between

`class Between : `[`Op`](../-op/index.md)`<Boolean>`

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `Between(expr: `[`Expression`](../-expression/index.md)`<*>, from: `[`LiteralOp`](../-literal-op/index.md)`<*>, to: `[`LiteralOp`](../-literal-op/index.md)`<*>)` |

### Properties

| Name | Summary |
|---|---|
| [expr](expr.md) | `val expr: `[`Expression`](../-expression/index.md)`<*>` |
| [from](from.md) | `val from: `[`LiteralOp`](../-literal-op/index.md)`<*>` |
| [to](to.md) | `val to: `[`LiteralOp`](../-literal-op/index.md)`<*>` |
