[org.jetbrains.exposed.sql](../index.md) / [Avg](.)

# Avg

`class Avg<T : Comparable<T>, in S : T?> : `[`Function`](../-function/index.md)`<`[`BigDecimal`](http://docs.oracle.com/javase/6/docs/api/java/math/BigDecimal.html)`?>`

### Constructors

| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `Avg(expr: `[`Expression`](../-expression/index.md)`<in S>, scale: Int)` |
